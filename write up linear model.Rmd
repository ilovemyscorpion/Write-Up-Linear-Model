...
SIMS= -4.1 + .0545*ARM
The scatter plot shows a positive relationship between SIMS & ARM.
...
SIMS= -4.8 + .045*GRIP
The scatter plot shows a positive relationship between SIMS & GRIP; the adjusted R square is 0.405 with a residual standard error of 1.295 that is the standard deviation of the normal spread of errors of any error along the line.
...
The anova compares model 1 with model 3; the null hypothesis is no difference in ability to predict SIMS. The alternative hypothesis is that there is a difference to predict SIMS. The p-value is 0.000005; this is so small that the difference in the ability to predict SIMS is not due to chance. The adjusted r-square and the standard deviation of the errors both show that the ARM + GRIP model is the better one. The prediction of the ARM + GRIP model is 0.15 and the 95% confidence interval is -2.1 to 2.4.
